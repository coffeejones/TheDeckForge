-- Drop child tables first (they reference other tables)
...
-- Drop parent tables last (they are referenced by others)
...
(
    ...
    Format        Varchar(50),
    CommanderCard BIGINT,
    UserId        BIGINT       not null,
    foreign key (UserId) references Users (UserId),
    foreign key (CommanderCard) references Cards(CardId)
);
